...
function NoFavorites({ navigate }) {
    return (
        <div className="bg-gradient-to-tr from-blue-200 to-gray-100 py-24 min-h-screen flex flex-col items-center justify-center px-4">
            <img src={DogImage} alt="No favorites" className="w-64 h-auto" />
            <h2 className="text-2xl tracking-tight text-pretty text-gray-900 py-5">
...
function MatchResult({ matchedDog, clearFavorites, navigate }) {
    return (
        <div className="bg-gradient-to-b from-blue-200 to-gray-100 min-h-screen flex flex-col items-center justify-center px-4">
            <h1 className="text-6xl font-semibold tracking-tight text-pretty text-gray-900 mb-6">
                Your Match
            </h1>
            <div className="mb-10">
...
function InitialMatchUI({ handleGetMatch, error }) {
    return (
        <div className="bg-gradient-to-b from-blue-200 to-gray-100 min-h-screen flex flex-col items-center justify-center px-4">
            ...
            <h2 className="text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-2xl mt-4">
...
export default function GetAMatchPage() {
    ...
    if (favorites.length === 0) {
        return <NoFavorites navigate={navigate} />;
    }
