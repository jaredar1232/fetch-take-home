...
export default function HomePage() {
    ...
    const [curPageQuery, setCurPageQuery] = useState(
        '/dogs/search?sort=breed:asc&size=9'
    ) // Default query with sort and size
        ...
        async function fetchDogData() {
            ...
            try {
                ...
                if (!idJson.resultIds?.length) {
                    ...
                    if (!dataResponse.ok)
                        throw new Error(
                            `Data fetch failed: ${dataResponse.status}`
                        )
    ...
    return (
        <div className="bg-gradient-to-l from-blue-200 to-gray-100 pt-44 pb-10">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="flex flex-col items-center justify-between pb-10 lg:flex-row">
                    <div className="flex-grow">
                        <h1 className="text-6xl font-semibold tracking-tight text-pretty text-gray-900">
                            Step 1
                        </h1>
                        <h2 className="pt-5 text-4xl tracking-tight text-pretty text-gray-900">
                            Heart your favorite dogs! Use sorting and filters to
                ...
                {isLoading ? (
                    ...
                    <ul
                        role="list"
                        className="mx-auto mt-10 grid grid-cols-1 gap-x-8 gap-y-16 sm:grid-cols-2 lg:grid-cols-3"
                    >
                        {dogData.map((dog) => (
                ...
                <div className="grid grid-cols-1 items-center pt-20 sm:grid-cols-3">
                    ...
                    <div className="my-4 flex flex-col items-center sm:my-0">
                        <div className="flex justify-center space-x-10">
                            <button
                                ...
                                className="cursor-pointer rounded-md bg-gradient-to-b from-blue-800 to-blue-500 px-3.5 py-2.5 text-sm font-semibold text-white drop-shadow-lg hover:from-blue-500 hover:to-blue-300 focus:outline-none disabled:from-gray-600 disabled:to-gray-400"
                            >
                                Prev
                            </button>
                    ...
                    <div className="flex justify-center sm:justify-end">
                        <button
                            ...
                            className="cursor-pointer rounded-md bg-gradient-to-b from-purple-800 to-purple-600 px-3.5 py-2.5 text-sm font-semibold text-white drop-shadow-lg hover:from-purple-500 hover:to-purple-300 focus:outline-none"
                        >
                            Step 2
                        </button>
                    </div>
