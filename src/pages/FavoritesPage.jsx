            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between py-4">
                    ...
                    <button
                        ...
                        className="cursor-pointer flex items-center gap-2 drop-shadow-lg rounded-xl bg-gradient-to-b from-blue-800 to-blue-500 px-3.5 py-2.5 text-sm font-semibold text-white hover:bg-gradient-to-b hover:from-blue-500 hover:to-blue-300 focus:outline-none"
                    >
